...
@section('title', 'Admin - Daily')

@section('main-title', 'Data Harian')
...
<div class="container-fluid">
    ...
    <div class="row">
        <button type="button" class="btn btn-primary ml-auto mb-3" id="btn-add" data-toggle="modal"
            data-target=".create-data-daily-modal">
            Tambah data</button>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#editDailyData', function () {
            ...
            $.get("{{ route('daily.index') }}" +'/' + uuid +'/edit', function (data) {
                $('#modalTitle').html("Edit Data Harian");
                $('#btn-submit').val("Edit Data");
                $('.create-data-daily-modal').modal('show');
                $('#type').val('update');
                $('#uuid').val(data.uuid);
...
<div class="modal fade create-data-daily-modal w-100" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="daily-form" class="daily-form" action="{{ route('daily.store') }}" method="POST"
